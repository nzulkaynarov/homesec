...
- Осталось из аудита (спринт 2 бота, docs/08): киллер-фича «запрос +времени»
  со страницы /blocked с round-trip к родителю в бот (новая модель
  BonusRequest + хендлер) — НЕ сделано, отдельный PR.
